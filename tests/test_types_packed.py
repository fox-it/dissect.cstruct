...
def test_packed_read(cs: cstruct):
...
def test_packed_array_read(cs: cstruct):
...
def test_packed_array_write(cs: cstruct):
...
def test_packed_be_read(cs: cstruct):
    cs.endian = ">"
...
def test_packed_be_write(cs: cstruct):
    cs.endian = ">"
...
def test_packed_be_array_read(cs: cstruct):
    cs.endian = ">"
...
def test_packed_be_array_write(cs: cstruct):
    cs.endian = ">"
...
def test_packed_float_struct(cs: cstruct, compiled: bool):
    cdef = """
    struct test {
        float16 a;
        float   b;
...
def test_packed_float_struct_be(cs: cstruct, compiled: bool):
    cdef = """
    struct test {
        float16 a;
        float   b;
